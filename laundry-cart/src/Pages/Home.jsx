...
const Home = () => {
    ...
    const [redesign,setRedesign] = useState(["brand-name",'description','home-left-sub']);
    return (
        <div className='home-main'>
            <div className='home-page'>
                <div className='home-left'>
                    <div className={redesign[2]}>
                        <div className={redesign[0]}>Laundry<br />service</div>
                        <div className={redesign[1]}>
                        ...
                        {!registerToggle ?
                            <>
                                ...
                                <button className='register' onClick={e => {
                                    ...
                                    setRedesign(["brand-name-small", 'description-small','home-left-sub-small'])
                                }}>Register</button>
                            </> :
                            <>
                ...
                {!(registerToggle) ?  
                <div className='signIn-form'><SignIn /></div> : <Register/>}
            </div>
