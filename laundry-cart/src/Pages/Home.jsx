        ...
        <div className='home-main'>
            <div className='home-page'>
                <div className='home-left'>
                    <div className='brand-name'>Laundry<br />service</div>
                    ...
                    <button className='register' onClick={e => setRegisterToggle(true)}>Register</button>
                </div>
                <div className='div-line'></div>
                {!(registerToggle) ?  
                <div className='signIn-form'><SignIn /></div> : <div className='registration-form'><Register/></div>}
            </div>
